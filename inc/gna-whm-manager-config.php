<?php
if (!class_exists('GNA_WHM_Config')) {
	class GNA_WHM_Config{
		var $configs;
		var $message_stack;
		static $_this;
		...
		function load_config() {
			$this->configs = get_option('g_whm_configs');
		}
		...
		function save_config() {
			update_option('g_whm_configs', $this->configs);
		}
